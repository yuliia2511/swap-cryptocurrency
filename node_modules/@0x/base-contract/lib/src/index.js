    ...
    _evmExecAsync(encodedData) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            if (this._evmIfExists === undefined) {
                ...
                yield vm.stateManager.putAccount(accountAddress, account);
                // 'deploy' the contract
                ...
                yield vm.stateManager.putContractCode(toAddress, this._deployedBytecodeIfExists);
                // save for later
            ...
            try {
                ...
                const result = yield this._evmIfExists.runCall(callOpts);
